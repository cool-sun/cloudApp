...
import (
	...
	versioned "github.com/coolsun/cloud-app/k8s/crd/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/coolsun/cloud-app/k8s/crd/pkg/generated/informers/externalversions/internalinterfaces"
	v1 "github.com/coolsun/cloud-app/k8s/crd/pkg/generated/listers/app/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.CloudV1().Apps(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CloudV1().Apps(namespace).Watch(context.TODO(), options)
			},
		},
		&appv1.App{},
		resyncPeriod,
...
func (f *appInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&appv1.App{}, f.defaultInformer)
}
