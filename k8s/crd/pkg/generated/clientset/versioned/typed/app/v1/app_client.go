...
import (
	v1 "github.com/coolsun/cloud-app/k8s/crd/pkg/apis/app/v1"
	"github.com/coolsun/cloud-app/k8s/crd/pkg/generated/clientset/versioned/scheme"
...
// CloudV1Client is used to interact with features provided by the cloud.k8s.io group.
type CloudV1Client struct {
	restClient rest.Interface
}

func (c *CloudV1Client) Apps(namespace string) AppInterface {
